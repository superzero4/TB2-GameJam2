...
{
    [Header("Settings")] [SerializeField] private int maxPlayers = 4;
        ...
        NetworkManager.ConnectionApprovalResponse response)
    {
        ...
        {
            clientSceneMap[request.ClientNetworkId] = connectionPayload.clientScene;
            clientIdToGuid[request.ClientNetworkId] = connectionPayload.clientGUID;
            clientData[connectionPayload.clientGUID] =
                new PlayerData(connectionPayload.playerName, request.ClientNetworkId);
        }
        ...
        gameNetPortal.ServerToClientConnectResult(request.ClientNetworkId, gameReturnStatus);
